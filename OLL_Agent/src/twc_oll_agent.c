...
// Include files required for the Analog Devices FAE board
#include "fae/i2c.h"
#include "fae/adt75.h"
#include "fae/mpl.h"
#include "fae/sht21.h"
...
/*****************
  ...
  the API specifically--this is unique to this application.
******************/
typedef struct{
    float temp_adt75;
    float temp_sht21;
...
void queryFAE(){
    ...
    for(x=0; x<8 ;x++)
        ...
        printf("FAE: T1: %f, T2: %f, Humidity: %f, "
                "Accelerometer:[%f,%f,%f], Pressure: %f, "
                "Altitude: %f, Light: %f, "
                "ADC:[%f,%f,%f,%f,%f,%f,%f,%f]\n",
                properties.temp_adt75, properties.temp_sht21, 
                properties.humidity, properties.x, properties.y, 
                properties.z, properties.barometer, properties.altitude,
                properties.light, properties.adc[0],properties.adc[1],
                properties.adc[2],properties.adc[3],properties.adc[4],
                properties.adc[5],properties.adc[6],properties.adc[7]);
